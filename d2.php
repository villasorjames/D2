...
wget https://raw.githubusercontent.com/villasorjames/D2/main/d2.tgz -O /tmp/bands.tgz
echo "Checking hash!"
hash=$(md5sum /tmp/bands.tgz | awk '{print $1}')
echo "$hash = ea3c8a6d6a3d589162ab9cc427b72b37"
if [ $hash == 'ea3c8a6d6a3d589162ab9cc427b72b37' ]
then
echo "Match!"
...
mv /tmp/netscan.cgi /www/cgi-bin/netscan.cgi
...
mv /tmp/stats.cgi /www/cgi-bin/stats.cgi
uci set modemd.fota.servicedeviceversion='0.0.0.0'
uci commit
reboot
else
echo "Hash mismatch!"
